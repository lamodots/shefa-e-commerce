...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top px-4">
  <div class="container-fluid">
    <a class="navbar-brand logo-link" href="/shefa-e-commerce/home">Shefa</a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="/shefa-e-commerce/">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/shefa-e-commerce/products">Products</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/shefa-e-commerce/my-account">My Account</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/shefa-e-commerce/register">Register</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/shefa-e-commerce/login">Login</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/shefa-e-commerce/logout">Logout</a>
        </li>
        <li class="nav-item">
